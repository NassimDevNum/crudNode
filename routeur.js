...
routeur.use("/", authController);

// Routes des livres (accueil, liste, CRUD)
routeur.use("/", livreController);

// Routes admin (dashboard, gestion users et livres)
routeur.use("/admin", adminController);
